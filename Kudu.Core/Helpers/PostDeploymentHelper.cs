...
namespace Kudu.Core.Helpers
{
    public static class PostDeploymentHelper
    {
        ...
        public static async Task UpdatePackageName(ArtifactDeploymentInfo deploymentInfo, IEnvironment environment, ILogger logger)
        {
            ...
            logger.Log($"Updating {packageNamePath} with deployment {deploymentInfo.FileName}");
            await FileSystemHelpers.WriteAllTextToFileAsync(packageNamePath, deploymentInfo.FileName);
        }
    }
}
